	...
	<html>
		<head>
			...
			<div class="error-message">
				⚠️ Nome de usuário e senha inválidos.
			</div>
			<%
			}
			%>
								...
								<form action="<%=request.getContextPath() %>/login" method="post">
									<div class="form-group">
										<label for="user"><span class="icon">👤</span>Usuário:</label>
										<input type="text" id="user" name="user" required placeholder="Digite seu usuário">
									</div>

									<div class="form-group">
										<label for="password"><span class="icon">🔒</span>Senha:</label>
				...
				%>
									...
									<div class="signup-link">
										Não tem uma conta? <a href="<%=request.getContextPath() %>/pessoa/cadastrar">Crie uma conta</a>
									</div>
								</form>
							</div>
						</div>
